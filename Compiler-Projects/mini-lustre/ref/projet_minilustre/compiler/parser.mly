...
| expr FBY expr
    { mk_expr (PE_fby ($1, $3)) }
| expr WHEN CONST_BOOL expr
    { mk_expr (PE_when ($1, (Cbool $3), $4)) }
| expr WHEN CONST_INT expr
    { mk_expr (PE_when ($1, (Cint $3), $4)) }
| expr WHEN CONST_FLOAT expr
    { mk_expr (PE_when ($1, (Cfloat $3), $4)) }
| expr WHEN CONST_STRING expr
    { mk_expr (PE_when ($1, (Cstring $3), $4)) }
| expr PLUS expr          
...
| MERGE expr lparen_const_arrow_expr_rparen_list
    { mk_expr (PE_merge ( $2, $3)) }
;
...
| LPAREN CONST_BOOL ARROW expr RPAREN lparen_const_arrow_expr_rparen_list
    { (Cbool $2, $4) :: $6 }
| LPAREN CONST_INT ARROW expr RPAREN lparen_const_arrow_expr_rparen_list
    { (Cint $2, $4) :: $6 }
| LPAREN CONST_FLOAT ARROW expr RPAREN lparen_const_arrow_expr_rparen_list
    { (Cfloat $2, $4) :: $6 }
| LPAREN CONST_STRING ARROW expr RPAREN lparen_const_arrow_expr_rparen_list
    { (Cstring $2, $4) :: $6 }
| LPAREN CONST_BOOL ARROW expr RPAREN {[(Cbool $2, $4)]}
| LPAREN CONST_INT ARROW expr RPAREN {[(Cint $2, $4)]}
| LPAREN CONST_FLOAT ARROW expr RPAREN {[(Cfloat $2, $4)]}
| LPAREN CONST_STRING ARROW expr RPAREN {[(Cstring $2, $4)]}
;
